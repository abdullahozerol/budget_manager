...
class FRAddExpenseViewModelFactory(private val repository: Repository, private val expenseId: Long, private val expenseData: ExpenseDao, private val lastCurrencyData: LastCurrencyDao) :
