...
import com.ozerol.budgetmanager.addexpense.FRAddExpenseViewModel
import com.ozerol.budgetmanager.database.ExpenseDao

class FRDetailExpenseViewModelFactory (private val expenseId: Long, private val expenseData: ExpenseDao): ViewModelProvider.Factory{
